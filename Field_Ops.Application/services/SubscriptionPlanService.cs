...
namespace Field_Ops.Application.services
{
    public class SubscriptionPlanService : ISubscriptionPlanService
    {
        ...
        public async Task<ApiResponse<IEnumerable<dynamic>>> GetAllAsync()
        {
            ...
            return ApiResponse<IEnumerable<dynamic>>.SuccessResponse(200, "Plans fetched succesfully",list);
        }
        ...
        public async Task<ApiResponse<dynamic>> GetByIdAsync(int id)
        {
            ...
            return ApiResponse<dynamic>.SuccessResponse(200, "plan fetched succesully",plan);
        }
        ...
        public async Task<ApiResponse<bool>> UpdateAsync(SubscriptionPlanUpdateDto dto)
        {
            ...
            return ApiResponse<bool>.SuccessResponse(200, "Subscription plan updated successfully.");
        }
        ...
        public async Task<ApiResponse<bool>> DeleteAsync(int id, int deletedBy)
        {
            ...
            return ApiResponse<bool>.SuccessResponse(200, "Subscription plan deleted successfully.");
        }
    }
